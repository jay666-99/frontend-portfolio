...
class Equipment extends Component {
  render() {
    ...
    <div id="main">
		...
		<h3>Harness</h3>
		<img className="alignright" src="https://lh3.googleusercontent.com/proxy/yRncrSKbu44n4Uxhbca8BMV3Begusl2hag2mskQ0gxQpjtp0_yMdbLt2BAb5z3NrcfsahxuJ6lJjxLg8ktSYL4kM20l4QdxfFuVuCVEn4mI8T58a5K8rwC3GX6Lpb0VZMoYG3udhX-JP9ns" alt="A rock climbing harness" />
		...
		<h3>Shoes</h3>
		<img className="alignright" src="https://lh3.googleusercontent.com/proxy/oAqqhY3VOd2GlZCuY0pHftfpPG4Hoi4Q2GiDIOarl3p26hyexycUTqwqR225HKWE9Ib5Hl0LmBsO2GjXeeUOIy6hHzPW1-goaW1JCRef8-8HzZN09hGRqMsjeoHHaDhRBn86bg" alt="A rock climbing shoe" />
		...
		<h3>Belay Device</h3>
		<img className="alignright" src="https://www.bing.com/images/blob?bcid=Tm--2S-UT38Dow" alt="An ATC-style belay device" />
		...
		<img className="alignright" src="https://www.bing.com/images/blob?bcid=ThoMWjsCSH8DEw" alt="A chalk bag and a carabiner" />
		...
		<h3>Helmet</h3>
		<img className="alignright" src="https://www.bing.com/images/blob?bcid=TgyLX.XW9X8DQA" alt="A climbing helmet" />
