...
class TypeOfClimp extends Component {
  render() {
		return(
    <div id="main">
		<h2 id="type">Types of Climbing</h2>
		<h3>Indoor versus Outdoor</h3>
		<img className="alignleft" src="https://www.bing.com/images/blob?bcid=Tja32JqB5X8DWQ" alt="A rock climbing wall in a gym" />
